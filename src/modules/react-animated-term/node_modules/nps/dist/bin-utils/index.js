...
exports.specificHelpScript = exports.loadCLIConfig = exports.loadConfig = exports.preloadModule = exports.getModuleRequirePath = exports.help = exports.initialize = undefined;
...
function loadCLIConfig(configPath) {
  try {
    var _JSON$parse = JSON.parse((0, _fs.readFileSync)(configPath)),
        config = _JSON$parse.config,
        _require = _JSON$parse.require;

    return { config, require: _require };
  } catch (err) {
    throw new Error(`Failed to parse CLI configuration file: ${configPath}`, err);
  }
}
