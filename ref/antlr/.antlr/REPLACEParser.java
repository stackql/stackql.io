// Generated from /mnt/c/LocalGitRepos/stackql/web-properties/stackql.io/ref/antlr/REPLACE.g4 by ANTLR 4.13.1
...
public class REPLACEParser extends Parser {
	...
	public static final int
		...
		REFRESH=162;
	public static final int
		RULE_replaceStatement = 0, RULE_fullFieldAssignment = 1, RULE_fieldValue = 2, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"replaceStatement", "fullFieldAssignment", "fieldValue", "provider", 
			"version", "fullFieldName", "functionCall", "alias", "number", "groupByItem", 
			"resourceOrSubQuery", "resource", "multipartIdentifier", "pattern", "expression", 
			"providerMethodName", "parameterName", "parameterValue", "parameterExpression", 
			"queryHint", "fieldList", "selectStatement", "awaitQueryHint", "viewName"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "REPLACE.g4"; }
	...
	public REPLACEParser(TokenStream input) {
		super(input);
	...
	public static class ReplaceStatementContext extends ParserRuleContext {
		public TerminalNode REPLACE() { return getToken(REPLACEParser.REPLACE, 0); }
		public MultipartIdentifierContext multipartIdentifier() {
			return getRuleContext(MultipartIdentifierContext.class,0);
		}
		public TerminalNode SET() { return getToken(REPLACEParser.SET, 0); }
		...
		public TerminalNode WHERE() { return getToken(REPLACEParser.WHERE, 0); }
		...
		public List<TerminalNode> AND() { return getTokens(REPLACEParser.AND); }
		public TerminalNode AND(int i) {
			return getToken(REPLACEParser.AND, i);
		}
		public List<TerminalNode> OR() { return getTokens(REPLACEParser.OR); }
		public TerminalNode OR(int i) {
			return getToken(REPLACEParser.OR, i);
		}
	...
	public final ReplaceStatementContext replaceStatement() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_replaceStatement);
		int _la;
		try {
