...
See also:  
[__[` SELECT `]__](/docs/language-spec/select) [__[` DESCRIBE `]__](/docs/language-spec/describe) [__[` JSON_EQUAL `]__](/docs/language-spec/functions/json/json_equal) [__[` JSON_EXTRACT `]__](/docs/language-spec/functions/json/json_extract) [[ Data Types ]](/docs/language-spec/data-types)
* * *
:::tip
